...
InstrumentRegistry make_options_registry()
{
    ...
    // AAPL Jan $150 call (id=10)
    {
        ...
        r.add(InstrumentSpec{
            InstrumentId{10}, c.occ_symbol(), InstrumentType::Option, 1, 1, "USD", c});
    }
    // AAPL Jan $150 put (id=11)
    {
        ...
        r.add(InstrumentSpec{
            InstrumentId{11}, c.occ_symbol(), InstrumentType::Option, 1, 1, "USD", c});
    }
    // AAPL Feb $155 call (id=12)
    {
        ...
        c.option_type = OptionType::Call;
        r.add(InstrumentSpec{
            InstrumentId{12}, c.occ_symbol(), InstrumentType::Option, 1, 1, "USD", c});
    }
    // AAPL Feb $155 put (id=13)
    {
        ...
        c.option_type = OptionType::Put;
        r.add(InstrumentSpec{
            InstrumentId{13}, c.occ_symbol(), InstrumentType::Option, 1, 1, "USD", c});
    }
    r.freeze();
    return r;
}
